    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Haowise</h3>
            <p className="text-gray-300 mb-4">
              领先的AI技术服务与云资源分销解决方案提供商
            </p>
            <p className="text-gray-300">
              Leading AI technology services and cloud resource distribution solutions provider
            </p>
          </div>
          ...
          <div>
            ...
            <address className="text-gray-300 not-italic">
              <p className="mb-1">中国上海市</p>
              <p className="mb-1">Shanghai, China</p>
              <p className="mb-1">info@haowise.com</p>
            </address>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/products" className="text-gray-300 hover:text-white transition-colors">产品</Link></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            &copy; {new Date().getFullYear()} Haowise. 保留所有权利. | All rights reserved.
          </p>
          <div className="mt-2">
            <Link href="/privacy" className="text-gray-400 hover:text-white mx-2 transition-colors">隐私政策</Link>
            <Link href="/terms" className="text-gray-400 hover:text-white mx-2 transition-colors">使用条款</Link>
          </div>
        </div>
      </div>
    </footer>
