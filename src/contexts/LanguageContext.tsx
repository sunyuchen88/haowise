...
const translations: Record<Language, Translations> = {
  zh: {
    ...
    'heroDescription': 'Haowise 为全球企业提供领先的AI自动化与智能化解决方案提供商。无论是RPA实施、低代码平台开发，还是AI Agent与GPU算力资源的高效配置，我们提供一站式解决方案，助您快速实现数字化转型。',
    'heroCtaPrimary': '立即咨询',
    'heroCtaSecondary': '查看方案',
    'keyPointsTitle': '我们的核心优势',
    'keyPoint1Title': '软件定制化开发',
    'keyPoint1Description': '制造业数智化解决方案，基于AI驱动的软件定制开发',
    'keyPoint2Title': 'RPA实施支持',
    'keyPoint2Description': '支持UiPath、影刀RPA和微软Power Automate定制开发实施',
    'keyPoint3Title': '低代码服务',
    'keyPoint3Description': '基于Power Platform的低代码定制开发服务（基于SharePoint、Power Apps、Power Automate和Power BI）',
    'keyPoint4Title': 'AI Agent开发',
    'keyPoint4Description': '企业级AI Agent与RPA+Agent融合开发',
    'keyPoint5Title': '工业CV质检',
    'keyPoint5Description': '工业品的CV缺陷检测，从算法选型到模型部署，物体检测、图像分割技术，无监督异常检测算法和多模态模型等综合应用',
    ...
    'contactInfoAddressValue': '中国江苏省无锡市梁溪区会岸路90号',
    'contactInfoEmail': '邮箱',
    'contactInfoPhone': '电话',
  ...
  en: {
    ...
    'keyPoint1Description': 'Digital and Intelligent Solutions for Manufacturing，AI-driven software customization development',
    'keyPoint2Title': 'RPA Implementation Support',
    'keyPoint2Description': 'UiPath UiBot and Yingdao RPA implementation support',
    ...
    'keyPoint5Title': 'Industrial Machine Vision Quality Inspection',
    'keyPoint5Description': 'Industrial product CV defect detection, comprehensive application from algorithm selection to model deployment, including object detection, image segmentation techniques, unsupervised anomaly detection algorithms, and multimodal models',
    ...
    'contactInfoAddressValue': 'No. 90 Hui\'an Road, Liangxi District, Wuxi City, Jiangsu Province, China',
    'contactInfoEmail': 'Email',
    'contactInfoPhone': 'Phone',
    'contactInfoHours': 'Office Hours',
    'contactInfoHoursValue': 'Monday - Friday: 9:00 - 18:00\nSaturday: 10:00 - 16:00\nSunday: Closed',
